...
# The texture to draw your animated rings from - sprite_frames must be arranged horizontally and spaced evenly
@export var spriteTexture = preload("res://Graphics/Gimmicks/ICZTrampolineRingAnim.png")

# The total number of sprite_frames in your texture animation
